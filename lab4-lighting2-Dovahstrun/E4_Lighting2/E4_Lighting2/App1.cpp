...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in, bool VSYNC, bool FULL_SCREEN)
{
	...
	light[0]->setPosition(70.0f, 10.0f, 50.0f);

	light[1] = new Light();
	light[1]->setDiffuseColour(0.0f, 1.0f, 0.0f, 1.0f);
	light[1]->setPosition(30.0f, 10.0f, 50.0f);

	attnValues.constFactor = 0.5f;
	attnValues.linFactor = 0.125f;
	attnValues.quadFactor = 0.0f;
